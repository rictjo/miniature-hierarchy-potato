...
<!--<h1 style="display: none;">Hierarchical edge bundling</h1>
<a href="https://d3js.org/">D3</a> › <a href="/@d3/gallery">Gallery</a>-->
</div>

# HPA edge bundling

This chart shows relationships among HPA classes in a data driven hierarchy. Hover a class to reveal its genetic connections (<b style="color: ${colorout};">outgoing</b> edges) and classes that connect to or from it (<b style="color: ${colorin};">incoming</b> edges).`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["flare.json", {url: new URL("https://gist.githubusercontent.com/rictjo/ed2291b29bf4acfa8540fd7887355b44/raw/7a64035226c26876bdfb1ae4c63bd365ab3cda62/data.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
